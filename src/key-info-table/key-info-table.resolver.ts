...
export class KeyInfoTableResolver {
  ...
  createKeyInfoTable(
    @Args("createKeyInfoTableInput")
    createKeyInfoTableInput: CreateKeyInfoTableInput
  ) {
  ...
  @Mutation(() => KeyInfoTable)
  updateKeyInfoTable(
    @Args("updateKeyInfoTableInput")
    updateKeyInfoTableInput: UpdateKeyInfoTableInput
  ) {
